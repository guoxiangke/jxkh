 ...
 */
?>
<div class="user_notes_final">
  <div class="sbq_head">
    <div class="sbq_title"><?php print $title; ?></div>
    <div class="sbq_time"><?php print $date; ?></div>
  </div>
  <div class="sbq_article_content">
    <?php
      // We hide the comments and links now so that we can render them later.
      hide($content['field_grow_records_video']);
      hide($content['field_grow_records_voice']);
    ...
    <div class="sbq_notes_down sbq_video">
      <div class="sbq_inner">
        <a href="<?php print file_create_url($content['field_grow_records_video'][0]['#file']->uri); ?>" title="点击下载">
          <div class="sbq_icon"></div>
          <div class="sbq_title"><?php print render($content['field_grow_records_video'][0]['#file']->filename); ?>&nbsp;下载</div>
        </a>
      </div>
    </div>
    <?php endif; ?>
    ...
    <div class="sbq_notes_down sbq_record">
      <div class="sbq_inner">
        <a href="<?php print file_create_url($content['field_grow_records_voice'][0]['#file']->uri); ?>" title="点击下载">
          <div class="sbq_icon"></div>
          <div class="sbq_title"><?php print render($content['field_grow_records_voice'][0]['#file']->filename); ?>&nbsp;下载</div>
        </a>
      </div>
    </div>
    <?php endif; ?>
